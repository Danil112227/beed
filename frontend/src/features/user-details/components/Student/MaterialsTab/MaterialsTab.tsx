...
function MaterialsTab({ externalUserId }: MaterialsTabProps) {
	const { id } = useParams();
	...
	const materialsResult = useMaterialsQuery({
		isEnabled: !!id || !!externalUserId,
		isPaginationEnabled: true,
		queryType: "materials",
		queryKey: ["materials", { limit, offset, userId: id || externalUserId }],
		searchParams: {
			limit,
			offset,
	...
	const { results: materials, count: totalCount } = materialsResult;
