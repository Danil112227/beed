...
import { AddMaterialDialogProps } from "./types";

import Cross from "@assets/vectors/cross.svg?react";
import Upload from "@assets/vectors/upload.svg?react";

import "./AddMaterialDialog.styles.scss";

function AddMaterialDialog({ isVisible, onClose }: AddMaterialDialogProps) {
	const { id, lessonId } = useParams();

	const { mutate: createMaterialMutation } = useMutation<
		CreateMaterialSuccessResponse | CreateLessonMaterialSuccessResponse,
		CreateMaterialValidationError,
		CreateMaterial
	>({
				...
				onError(error) {
					...
					for (const key in errors) {
						if (Object.prototype.hasOwnProperty.call(errors, key)) {
							const errorKey =
								key as keyof CreateMaterialValidationError["data"];
			...
			content={({ hide }) => (
				<div className="popup">
					<div className="popup__head">
						<span className="popup__title main-title">Add material</span>
